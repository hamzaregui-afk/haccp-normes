...
-- CreateEnum
CREATE TYPE "NCCategory" AS ENUM (
    'TEMPERATURE',
    'HYGIENE',
    'LABELING',
    'TRACEABILITY',
...
-- AddForeignKey
ALTER TABLE "nc_photos" ADD CONSTRAINT "nc_photos_non_conformity_id_fkey"
    FOREIGN KEY ("non_conformity_id") REFERENCES "non_conformities"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
