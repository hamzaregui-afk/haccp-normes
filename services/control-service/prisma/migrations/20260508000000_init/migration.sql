-- CreateEnum
CREATE TYPE "ControlType" AS ENUM ('RECEPTION', 'TEMPERATURE_STOCK', 'TEMPERATURE_DISPLAY', 'TEMPERATURE_OIL', 'EQUIPMENT', 'SANITARY', 'DAILY_PRODUCTION');
...
-- AddForeignKey
ALTER TABLE "control_tasks" ADD CONSTRAINT "control_tasks_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "control_templates"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
